...
class PrimeGeneratorLoop: public BaseRunnable
{
    int *primes;
    int current;
    int stop;
...
protected:
    ...
    const SUCCESS run() {return BaseRunnable::run();};
...
class FibGeneratorLoop: public BaseRunnable
{
    int *fibs;
    int current;
    int stop;
